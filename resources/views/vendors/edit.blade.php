    ...
    <div class="container mx-auto px-6 py-8">
        ...
        <div class="flex items-center justify-between mb-5">
            <div class="flex items-center space-x-2">
                <h1 class="text-4xl font-extrabold text-main-dark italic mb-1">Edit Vendor</h1>
            </div>
        ...
        <div class="mt-8 py-6 rounded-lg">
            <form action="{{ route('vendors.update', $vendor) }}" method="POST">
                ...
                @php
                    $fields = [
                        ['name' => 'name', 'label' => 'Name', 'type' => 'text', 'value' => old('name', $vendor->name), 'required' => true],
                        ['name' => 'email', 'label' => 'Email', 'type' => 'email', 'value' => old('email', $vendor->email), 'required' => true],
                        ['name' => 'phone', 'label' => 'Phone', 'type' => 'text', 'value' => old('phone', $vendor->phone), 'required' => true],
                        ['name' => 'address', 'label' => 'Address', 'type' => 'text', 'value' => old('address', $vendor->address), 'required' => true],
                    ];
                @endphp
