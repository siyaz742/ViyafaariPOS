    ...
    <div class="container mx-auto px-6 py-8">
        ...
        <div class="flex items-center justify-between mb-5">
            <div class="flex items-center space-x-2">
                <h1 class="text-4xl font-extrabold text-main-dark italic mb-1">Edit Customer</h1>
            </div>
        ...
        <div class="mt-8 py-6 rounded-lg">
            <form action="{{ route('customers.update', $customer) }}" method="POST">
                ...
                @php
                    $fields = [
                        ['name' => 'name', 'label' => 'Name', 'type' => 'text', 'value' => old('name', $customer->name), 'required' => true],
                        ['name' => 'email', 'label' => 'Email', 'type' => 'email', 'value' => old('email', $customer->email), 'required' => true],
                        ['name' => 'phone', 'label' => 'Phone', 'type' => 'text', 'value' => old('phone', $customer->phone), 'required' => true],
                        ['name' => 'address', 'label' => 'Address', 'type' => 'text', 'value' => old('address', $customer->address), 'required' => true],
                        ['name' => 'tin', 'label' => 'TIN (Optional)', 'type' => 'text', 'value' => old('tin', $customer->tin), 'required' => false],
                    ];
                @endphp
